...
const badgeVariants = cva(
  "inline-flex items-center gap-1 rounded-[var(--radius-sm)] ring-1 font-semibold text-[11px] px-2 py-0.5 whitespace-nowrap",
  {
    variants: {
      tone: {
        neutral:
          "bg-white/5 text-[var(--color-fg-muted)] ring-[var(--color-border-strong)]",
